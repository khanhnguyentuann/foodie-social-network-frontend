...
const addReply = async (recipeId, commentId) => {
    try {
        ...
        await axios.post(`/api/newsfeed/comments/${commentId}/replies`, { userId: userStore.user.id, content: replyText.value[commentId] });
...
<style src="../../assets/OtherPostCard.css" scoped></style>
